      ...
      <Navbar bg="danger" data-bs-theme="dark">
        <Container>
          ...
          <Nav className="me-auto">
            <Nav.Link onClick={()=>{navigate('/page01')}}>BEST</Nav.Link>
            <Nav.Link onClick={()=>{navigate('/page02')}}>신상품</Nav.Link>
            <Nav.Link onClick={()=>{navigate('/page03')}}>정기배송</Nav.Link>
            <Nav.Link onClick={()=>{navigate('/page04')}}>이벤트</Nav.Link>
        ...
        <div >
          ...
          <Card className='card_box'>
            ...
            <Card.Body>
              ...
              <Button className='card_btn' onClick={() => navigate('/page01')}>더보기</Button>
          ...
          <Card className='card_box'>
            ...
            <Card.Body>
              ...
              <Button className='card_btn' onClick={() => navigate('/page02')}>더보기</Button>
            </Card.Body>
          </Card>
          </Col>
          ...
          <Card className='card_box' >
            ...
            <Card.Body>
              ...
              <Card.Text  className='card_text' >
              일주일에 다섯 번 집 앞으로 새벽배송 받으세요 !
              </Card.Text>
              <Button className='card_btn' onClick={() => navigate('/page03')}>더보기</Button>
            </Card.Body>
          </Card>
          </Col>
          </Row>
          ...
          <Container className='new_item'>
            ...
            {news.slice(0, 8).map((newArr,index)=>{
